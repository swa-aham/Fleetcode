  ...
  return (
    <div className="filter-panel">
      ...
      <div className="filter-section">
        <h4><SlidersHorizontal size={14} /> Difficulty</h4>
        <div className="filter-options difficulty-options">
          {difficulties.map(difficulty => (
            <label key={difficulty} className={`difficulty-tag ${difficulty.toLowerCase()}`}>
              <input
                type="checkbox"
      ...
      <div className="filter-section">
        <h4><Filter size={14} /> Companies</h4>
